...
const RequestsByDepartmentChart = () => {
    ...
    return (_jsxs("div", { children: [_jsx("h2", { className: "text-2xl text-center font-bold mb-4", children: "Requests by Department" }), _jsx(ReactECharts, { option: option, style: { height: '400px', width: '100%' } })] }));
};
