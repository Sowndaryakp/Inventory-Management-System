...
const MostRequestedToolsChart = () => {
    ...
    return (_jsxs("div", { children: [_jsx("h2", { className: "text-2xl text-center font-bold mt-5", children: "Most Requested Tools" }), _jsx(ReactECharts, { option: option, style: { height: '400px', width: '100%' } })] }));
};
